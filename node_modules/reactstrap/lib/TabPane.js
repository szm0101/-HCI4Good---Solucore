...
const _excluded = ["className", "cssModule", "tabId", "tag"];
...
function TabPane(props) {
  ...
  const getClasses = activeTabId => (0, _utils.mapToCssModules)((0, _classnames.default)('tab-pane', className, {
    active: tabId === activeTabId
  }), cssModule);
  return /*#__PURE__*/_react.default.createElement(_TabContext.TabContext.Consumer, null, ({
    activeTabId
