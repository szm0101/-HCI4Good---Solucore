    ...
    return(
      ...
      <div className="row">
        <div className="col-md-6">
          <Card className='h-100 dark-bg text-white'>
            <Card.Body >
              ...
              <Card.Text className='fs-5 text-start'>
                ...
                <div className="d-flex justify-content-center mt-4">
                    <Button className='mx-2 btn-lg' onClick={() => setEditModalShow(true)}>
                        Edit Profile
                    </Button>
                    <Button className='mx-2 btn-lg' onClick={() => setPasswordModalShow(true)}>
                        Change Password
                    </Button>
                </div>
              </Card.Text>
          ...
          <Card className='h-100 dark-bg text-white'>
            <Card.Body className="d-flex flex-column align-items-center justify-content-center mb-5">
              ...
              <Form.Group controlId="formFile" className="mt-5">
                <Form.Label className='btn btn-lg btn-primary'>Change Picture</Form.Label>
                <Form.Control 
                    type="file"
                    className='d-none'
                />
